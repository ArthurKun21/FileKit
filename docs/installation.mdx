...
implementation("io.github.vinceglb:filekit-core:0.14.0")
```
...
implementation("io.github.vinceglb:filekit-dialogs:0.14.0")

// Enables FileKit dialogs with Composable utilities
implementation("io.github.vinceglb:filekit-dialogs-compose:0.14.0")
```
...
```kotlin build.gradle.kts
implementation("io.github.vinceglb:filekit-coil:0.14.0")
```
